"""
    ...
    :license: Public domain, WTFPL, GNU GPLv2+, GNU AGPL, GNU LGPLv3+, 2-clause BSD, 3-clause BSD, Apache2, MIT, MPL, at your own choice. See https://github.com/sphinx-contrib/stuffcounter/blob/master/LICENSE.md for more information.
"""
